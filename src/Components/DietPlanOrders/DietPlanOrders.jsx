...
export default function DietPlanOrders(props)  {
  ...
  let toggle=()=>{
   ...
   let getData=()=>{
      ...
      Axios({method:'get',url:`http://localhost:5000/diet_plan_order/orders/${page}`, headers:{'x-auth-token':localStorage.getItem('admin-token')}})
      .then(res=>{
    ...
    return (
       ...
       <NavBar toggle={toggle} isOpen={isOpen }/>
        <div className='container'>
          <h1 className="text-center text-primary">Diet Plan Orders</h1>
