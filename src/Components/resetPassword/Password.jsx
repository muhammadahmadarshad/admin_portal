...
function changeConfirmPassword({target}){
    ...
    if(password.password!==target.value){
     ...
     const handleForm=(e)=> { 
        ...
        e.preventDefault()
        setLoading(true)
        Axios({method:'post',url:'http://localhost:5000/admin/forgotPassword',
     ...
     const handleVerification=(e)=> {
        ...
        e.preventDefault()
        setLoading(true)
        Axios({method:'post',url:'http://localhost:5000/admin/verify_opt',
      ...
      const handleReset=(e)=> {
        ...
        if(!confirmpassword.invalid){
            ...
            setLoading(true)
        Axios({method:'post',url:'http://localhost:5000/admin/resetPassword',
